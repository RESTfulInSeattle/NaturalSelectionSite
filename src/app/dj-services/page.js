  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-black text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            With 20 years of experience across nightclubs, weddings, corporate events, fundraisers, 
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Testimonials */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold mb-8 text-center text-gray-900">What Clients Say</h2>
          <div className="bg-white border border-gray-200 rounded-lg p-6 text-center">
            <p className="text-lg text-gray-700 mb-4">
              "You look like a mad scientist up there mixing records, like some crazy chemist"
            </p>
            <p className="font-semibold text-gray-900">- JJ Brown</p>
          </div>
